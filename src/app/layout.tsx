...
export const metadata: Metadata = {
  title: "Santa - Fine Dining Italian Restaurant",
  description: "Experience exceptional Italian cuisine at Santa. Elegant fine dining with authentic recipes, impeccable service, and unforgettable dining moments.",
  keywords: "fine dining, Italian restaurant, fine dining cuisine, reservations, gourmet food",
  metadataBase: new URL("https://santa-restaurant.com"),
  alternates: {
    canonical: "https://santa-restaurant.com"
  },
  openGraph: {
    title: "Santa - Fine Dining Italian Restaurant",
    description: "Discover culinary excellence at Santa. Authentic Italian cuisine in an elegant setting.",
    siteName: "Santa Restaurant",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765810985310-lfrtmyex.jpg",
      alt: "Santa restaurant dining experience"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Santa - Fine Dining Restaurant",
    description: "Experience exceptional Italian cuisine at Santa",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765810985310-lfrtmyex.jpg"]
  }
};
